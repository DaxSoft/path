...
FileJSON.prototype.initialize = function (route, { routeName }) {
    this._route = route
...
FileJSON.prototype.readSync = function ({ route = this._routeName, filename }) {
...
FileJSON.prototype.dispose = function ({ route = this._routeName, filename }) {
